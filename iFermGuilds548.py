...
#If set to true, will take into account ATP losses for transport
...
#Constraint_abundance_4 = model.problem.Constraint(model.reactions.LEO_ATP_Hydrolysis.flux_expression  - model.reactions.EEO_ATP_Hydrolysis.flux_expression, lb=0, ub=0)
#model.add_cons_vars(Constraint_abundance_4)

#Constraint_abundance_5 = model.problem.Constraint(model.reactions.EEO_ATP_Hydrolysis.flux_expression  - model.reactions.HAO_ATP_Hydrolysis.flux_expression, lb=0, ub=0)
#model.add_cons_vars(Constraint_abundance_5)

#Constraint_abundance_6 = model.problem.Constraint(model.reactions.HAO_ATP_Hydrolysis.flux_expression  - model.reactions.SEO_ATP_Hydrolysis.flux_expression, lb=0, ub=0)
#model.add_cons_vars(Constraint_abundance_6)"""
