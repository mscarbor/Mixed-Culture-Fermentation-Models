...
#PART III: CALCULATE INPUTS FOR TRANSPORT CONSTRAINTS
...
#PART I: ADD REACTIONS AND METABOLITES
#Names are consistent with BiGG Database (http://bigg.ucsd.edu)
...
glc4_e = Metabolite('glc4_e',formula='C24H48O24',name='glucan',compartment='e')

glc4_c = Metabolite('glc4_c',formula='C24H48O24',name='glucan',compartment='c')
...
#PART III: SET OBJECTIVE FUNCTION AND RUN MODEL WITH pFBA
...
#model.reactions.EX_octa_e.upper_bound = 0.0034 * Fract
#model.reactions.EX_octa_e.lower_bound = 0.0034 * (1+(1-Fract))

#model.reactions.EX_hxa_e.upper_bound = 0.0478 * Fract
#model.reactions.EX_hxa_e.lower_bound = 0.0478 * (1+(1-Fract))

"""model.reactions.EX_but_e.upper_bound = 0.0827 * Fract
model.reactions.EX_but_e.lower_bound = 0.0827 * (1+(1-Fract))

model.reactions.EX_ac_e.lower_bound = 0.0740 * Fract
model.reactions.EX_ac_e.upper_bound = 0.0740 * (1+(1-Fract))

model.reactions.EX_etoh_e.lower_bound = 0.0032 * Fract
model.reactions.EX_etoh_e.upper_bound = 0.0032 * (1+(1-Fract))

model.reactions.EX_for_e.lower_bound = 0.0001 * Fract
model.reactions.EX_for_e.upper_bound = 0.0001 * (1+(1-Fract))

#model.reactions.EX_h2_e.lower_bound = 0.437 * Fract
#model.reactions.EX_h2_e.upper_bound = 0.437 * (1+(1-Fract))
...
#PART IV: PRINT RESULTS TO EXCEL
...
#PART V: CALCULATE OVERALL THERMODYNAMICS
...
cobra.io.write_sbml_model(model, "/Users/mscarborough/cobratoolbox/FromPython/iFerment154.xml")
...
#PART IV: PRINT RESULTS TO EXCEL
#writer = pandas.ExcelWriter('iFerment155_FVA.xlsx')
